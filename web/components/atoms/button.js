...
const Button = ({ linkContent = {}, buttonVariant, onClick, className = ''}) => {
    ...
    switch (buttonVariant) {
        ...
        case 'close':
            return (
                <button className='absolute py-0.5 px-0.5 text-np-blue text-xl right-0 z-20 hover:text-np-pink' onClick={onClick}>
                    <svg className='fill-current h-8 w-8 md:h-10 md:w-10' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
