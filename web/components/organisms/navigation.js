            ...
            <Container variant={'nav'} className='flex flex-wrap items-center justify-center'>
                ...
                <div className='block flex flex-grow justify-end lg:hidden'>
                    <button onClick={handleClick} className='flex items-center'>
                        {isOpen && (
                            <svg className='fill-current h-5 w-5 mr-3' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                        ...
                        {!isOpen && (
                            <svg className='fill-current h-5 w-5 mr-3' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
