        ...
        <nav className='flex flex-wrap items-center justify-center m-auto max-w-6xl p-5 text-white relative z-20 lg:p-7'>
            <div className='flex items-center flex-shrink-0'>
                <a href='/' className='flex items-center'>
                    <svg className='bg-slate-50/50' width='43' height='49' style={{fill: 'rgba(53, 143, 170, 1)'}} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 125 142'>
            ...
            <div className='block flex flex-grow justify-end lg:hidden'>
                <button onClick={handleClick} className='flex items-center px-3 py-2'>
                    <svg className='fill-current h-5 w-5' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'><title>Open Menu</title><path d='M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z'/></svg>
                </button>
            </div>
